...
import { Descriptions, Tabs, Tag, Spin, Table, Button, Select, Space } from 'antd';
...
export default function ProjectDetailPage() {
  ...
  if (!project) {
    return <div className="text-center text-text-tertiary">项目不存在</div>;
  }

  return (
    <div>
      <PageHeader title={project.name} subtitle="项目详情" showBack />
      <Tabs
        items={[
          {
            key: 'info',
