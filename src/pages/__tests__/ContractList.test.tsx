  ...
  items: [
    {
      ...
      renterProfileId: 'rp-001',
      renterProfile: { id: 'rp-001', name: '张伟' },
      unitId: 'u-001',
      unit: { id: 'u-001', name: 'A栋-101', code: '101' },
      projectId: 'p-001',
      project: { id: 'p-001', name: '示例项目' },
      rentAmount: '5000',
      depositAmount: '5000',
    ...
    },
    {
      ...
      renterProfileId: 'rp-002',
      renterProfile: { id: 'rp-002', name: '李芳' },
      unitId: 'u-002',
      unit: { id: 'u-002', name: 'B栋-202', code: '202' },
      projectId: 'p-001',
      project: { id: 'p-001', name: '示例项目' },
      rentAmount: '8000',
      depositAmount: '8000',
